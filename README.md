...
> **Note:** As of v2.1.8, the config key has been renamed from `persistent_apk_packages` to `persistent_apt_packages`. The old key is still supported for backward compatibility.
