...
> **Note:** The configuration key was renamed to `persistent_apt_packages` in v2.1.8 to match the underlying Debian OS. The legacy key `persistent_apk_packages` remains supported for backward compatibility.
